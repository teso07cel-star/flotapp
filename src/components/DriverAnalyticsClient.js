                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                   ...
                   <div className="space-y-8">
                      ...
                      <div className="space-y-4">
                         <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Nodos Impactados:</p>
                         <div className="flex flex-wrap gap-2">
                            {d.branchesVisited.map((b, idx) => (
                              <span key={idx} className="bg-slate-950 text-white text-[9px] font-black uppercase px-4 py-2 rounded-lg italic tracking-widest">
                                 {b}
                              </span>
                            ))}
                         </div>
