...
export default function HomePageClient({ success, hasDriver }) {
  const driverLink = hasDriver ? "/driver/form" : "/driver/entry";
      ...
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 px-4">
          ...
          >
            ...
            <div className="p-6 md:p-8 pb-0 text-center relative z-10 mt-2">
               <h3 className="text-xl md:text-[22px] leading-tight font-black text-white tracking-widest uppercase mb-1 drop-shadow-[0_0_10px_rgba(59,130,246,0.5)]">
                  Acceso<br />Conductor
               </h3>
            </div>
            
            <div className="relative flex-1 flex flex-col items-center justify-center p-4 md:p-6 min-h-[220px] md:min-h-[260px]">
               {/* Professional Tactical Vertical Alignment */}
               <div className="flex flex-col items-center justify-center w-full relative z-10 gap-2 md:gap-4 pt-2">
                  <div className="w-full flex flex-col items-center justify-center transition-all duration-700 group-hover:-translate-y-2 relative z-10">
                     <div className="absolute bottom-10 md:bottom-14 w-[70%] max-w-[90px] md:max-w-[110px] h-1 md:h-[5px] bg-black/85 blur-[2px] rounded-[100%] z-0"></div>
                     <img src="/icons/etios_tactic_v2.png" className="w-full max-w-[130px] md:max-w-[160px] object-contain drop-shadow-[0_15px_15px_rgba(0,0,0,0.6)] z-10 relative" alt="Etios" />
                  </div>
                  <div className="w-full flex flex-col items-center justify-center transition-all duration-700 group-hover:-translate-y-2 relative z-20">
                     <div className="absolute bottom-5 md:bottom-6 w-[85%] max-w-[140px] md:max-w-[170px] h-1 md:h-[6px] bg-black/85 blur-[3px] rounded-[100%] z-0"></div>
                     <img src="/icons/pickup_tactic.png" className="w-full max-w-[170px] md:max-w-[210px] object-contain drop-shadow-[0_15px_15px_rgba(0,0,0,0.6)] z-10 relative" alt="Hilux" />
                  </div>
                  <div className="w-full flex flex-col items-center justify-center transition-all duration-700 group-hover:-translate-y-2 relative z-30">
                     <div className="absolute bottom-5 md:bottom-6 w-[95%] max-w-[125px] md:max-w-[155px] h-1 md:h-[4px] bg-black/80 blur-[2px] rounded-[100%] z-0"></div>
                     <img src="/icons/moto_tactic.png" className="w-full max-w-[120px] md:max-w-[150px] object-contain drop-shadow-[0_15px_15px_rgba(0,0,0,0.6)] z-10 relative saturate-[2.5] contrast-[1.25] brightness-110" alt="Moto XR 300" />
                  </div>
               </div>
            </div>
            
            <div className="p-6 md:p-8 pt-0 text-center space-y-4 md:space-y-6 relative z-10">
               <p className="text-slate-400 text-[9px] md:text-[11px] uppercase tracking-widest">Optimización de unidades</p>
               <div className="inline-block px-8 md:px-10 py-2.5 md:py-3 rounded-full border border-blue-500/50 text-blue-400 text-[9px] md:text-[10px] font-black uppercase tracking-widest group-hover:bg-blue-500 group-hover:text-white transition-all shadow-lg">Ver Más</div>
            </div>
          </Link>
          ...
          >
            ...
            <div className="p-6 md:p-8 pb-0 text-center relative z-10 mt-2">
               <h3 className="text-xl md:text-[22px] leading-tight font-black text-white tracking-widest uppercase mb-1 drop-shadow-[0_0_10px_rgba(147,197,253,0.5)]">
                  Movilidad<br />Inteligente
               </h3>
            </div>
            
            <div className="relative flex-1 flex flex-col items-center justify-center p-4 md:p-6 min-h-[180px] md:min-h-[220px]">
              <div className="relative w-full flex flex-col items-center justify-center z-20 group-hover:scale-110 group-hover:-translate-y-4 transition-all duration-700 pointer-events-none">
                 <img src="/icons/cross_official.png" alt="Toyota Corolla Cross" className="w-full max-w-[280px] md:max-w-[340px] px-2 object-contain drop-shadow-[0_15px_15px_rgba(0,0,0,0.6)] scale-x-[-1] relative z-10"/>
              </div>
            </div>
            
            <div className="p-6 md:p-8 pt-0 text-center space-y-4 md:space-y-6 relative z-10">
               <p className="text-slate-400 text-[9px] md:text-[11px] uppercase tracking-widest">Soluciones Avanzadas</p>
               <div className="inline-block px-8 md:px-10 py-2.5 md:py-3 rounded-full border border-blue-400/50 text-blue-300 text-[9px] md:text-[10px] font-black uppercase tracking-widest group-hover:bg-blue-400 group-hover:text-slate-900 transition-all shadow-lg">Descubrir</div>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative flex-1 flex flex-col items-center justify-center p-4 md:p-6 min-h-[180px] md:min-h-[220px]">
              <div className="w-40 h-40 md:w-56 md:h-56 relative flex items-center justify-center pl-4 py-2">
                <img 
              ...
              <div className="absolute bottom-4 right-6 md:bottom-6 md:right-8 z-30 opacity-60 group-hover:opacity-100 group-hover:rotate-45 transition-all duration-1000">
                 <StrategicGearIcon className="text-blue-500/40 animate-spin-slow w-16 h-16 md:w-20 md:h-20" />
              </div>
            </div>
            
            <div className="p-6 md:p-8 pt-0 text-center space-y-4 md:space-y-6 relative z-10">
               <p className="text-slate-400 text-[9px] md:text-[11px] uppercase tracking-widest">Control Operacional</p>
               <div className="inline-block px-8 md:px-10 py-2.5 md:py-3 rounded-full border border-blue-500/50 text-blue-400 text-[9px] md:text-[10px] font-black uppercase tracking-widest group-hover:bg-blue-500 group-hover:text-white transition-all shadow-lg">Gestionar</div>
            </div>
          </Link>
