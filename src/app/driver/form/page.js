...
export default async function DriverForm({ searchParams }) {
  try {
    ...
    // FALLBACK TOTAL SI FALLA TODO EL SERVER RENDER
    return <div className="min-h-screen bg-gray-950 text-white flex items-center justify-center p-10 font-black uppercase italic tracking-widest animate-pulse">Reiniciando Enlace Táctico...</div>;
  }
}
