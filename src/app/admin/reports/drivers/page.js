  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        ...
        <form className="flex items-center gap-3 bg-[#0f172a] p-2 rounded-2xl border border-slate-700 shadow-xl shadow-black/5">
              ...
              {driversList.map((d, index) => (
                  <div key={index} className="bg-gradient-to-br from-[#0f172a] to-slate-900 border border-slate-800 rounded-[2.5rem] p-6 sm:p-8 shadow-2xl relative overflow-hidden group">
                      ...
                      <div className="relative z-10 flex items-center justify-between border-b border-white/5 pb-6 mb-8">
                          <div>
                              <p className="text-[10px] font-black tracking-[0.3em] uppercase text-blue-500 mb-1">Mantenimiento de Conducta</p>
                              ...
                              <div key={idx} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                                  ...
                                  <div className="w-full bg-slate-800/20 border border-slate-700/50 rounded-2xl p-5 shadow-lg relative z-10 transition-colors hover:border-slate-500/50">
                                      ...
                                      <div className="flex flex-wrap gap-2 mt-3">
                                          ...
                                          {(!parada.sucursales || parada.sucursales.length === 0) && <span className="text-[9px] italic text-slate-600">Actualización Logística</span>}
                                      </div>
                                      ...
                                      <div className="mt-4 flex items-center gap-8">
                                          ...
                                          {parada.kmTeoricos > 0 && (
                                              <div className="border-l border-white/10 pl-8">
                                                  <p className="text-[8px] text-slate-500 uppercase font-black mb-1">Cálculo Teórico</p>
                                                  <p className="text-sm font-black text-blue-500/60">+{parada.kmTeoricos.toLocaleString()} <span className="text-[8px]">KM</span></p>
                                              </div>
                                          )}
                                      </div>
                                  </div>
                              ...
                              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                                  ...
                                  <div className="w-full bg-red-950/20 border border-red-500/20 rounded-2xl p-5 shadow-lg relative z-10">
                                      ...
                                      <div className="grid grid-cols-3 gap-2">
                                          <div>
                                              <p className="text-[8px] text-slate-500 uppercase font-black mb-1">km Final</p>
                                          ...
                                          <div>
                                              <p className="text-[8px] text-slate-500 uppercase font-black mb-1">Estado Comb.</p>
                                          ...
                                          <div className="text-right">
                                              <p className="text-[8px] text-slate-500 uppercase font-black mb-1">Ubicación GPS</p>
                          ...
                          {!d.cierre && (
                              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                                  ...
                                  <div className="w-full bg-slate-900/30 border border-slate-700 border-dashed rounded-2xl p-5 relative z-10 text-center">
                                      <p className="text-slate-500 font-black uppercase tracking-widest text-[9px] italic">Turno en Curso (ACTIVO)</p>
                                  </div>
                              </div>
                          )}
                      </div>
