...
export async function GET() {
  try {
    ...
    // 2. Vehículos Estratégicos (Desde data.json)
    ...
    const branches = [
      ...
      { id: 25, nombre: "Parque Patricios" }, { id: 26, nombre: "Once" }, { id: 27, nombre: "VOY Y VUELVO" },
      { id: 28, nombre: "Madero" }, { id: 29, nombre: "Canning" }, { id: 30, nombre: "Monte Grande" },
      { id: 31, nombre: "Adrogue" }, { id: 32, nombre: "Lomas" }, { id: 33, nombre: "Banfield" },
      { id: 34, nombre: "Lanus" }, { id: 35, nombre: "Avellaneda" }, { id: 36, nombre: "Wilde" },
      { id: 37, nombre: "Bernal" }, { id: 38, nombre: "Berazategui" }, { id: 39, nombre: "Varela" },
      { id: 40, nombre: "Berisso" }, { id: 41, nombre: "La Plata" }, { id: 42, nombre: "La Plata 56" },
      { id: 43, nombre: "Chascomus" }, { id: 44, nombre: "Gualeguaychú" }, { id: 45, nombre: "Concordia" },
      { id: 46, nombre: "La Paz" }, { id: 47, nombre: "Olavarría" }, { id: 48, nombre: "Tandil" },
      { id: 49, nombre: "Tres Arroyo" }, { id: 50, nombre: "Coronel Suarez" }, { id: 51, nombre: "Independencia (MDQ)" },
